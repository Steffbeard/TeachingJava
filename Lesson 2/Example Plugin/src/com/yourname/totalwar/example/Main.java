...
import com.yourname.totalwar.example.commands.ExampleCommand;
...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		// Ok let's register our commands
		
		/*
		 * this <--- this class which is Main
		 * 
		 * getCommand("ping") <---- sets the name of the command
		 * 
		 * setExecutor(new ExampleCommand()); <---- sets the class file that gets used which we just made ("ExampleCommand")
		 */
		this.getCommand("ping").setExecutor(new ExampleCommand());
		
		/*
		 * Now we need to put this in our plugin.yml
		 */
	}
